...
function createRegularPickupDateGroups(pickups, state, actions) {
...
function createRegularPickupRow(pickup, state, actions) {
...
function createRegularPickupAssignment(pickup, state, actions) {
...
function currentOpShopDriverName(pickup, state) {
...
function compareRegularPickups(left, right, state) {
...
function selectedOpShopDriverName(pickup, state) {
