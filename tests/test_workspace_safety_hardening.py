...
class WorkspaceSafetyHardeningTest(unittest.TestCase):
    ...
    def test_all_approved_scoped_routes_are_guarded_but_legacy_routes_remain_usable(self):
        ...
        requests = [
            ...
            ("post", "/api/manual-dispatch/delivery/drivers", {"json": {}}),
            ("patch", "/api/manual-dispatch/delivery/drivers/DRIVER-1", {"json": {}}),
            ("delete", "/api/manual-dispatch/delivery/drivers/DRIVER-1", {}),
            ("post", "/api/manual-dispatch/delivery/vehicles", {"json": {}}),
            ("patch", "/api/manual-dispatch/delivery/vehicles/VEHICLE-1", {"json": {}}),
            ("delete", "/api/manual-dispatch/delivery/vehicles/VEHICLE-1", {}),
            ("post", "/api/manual-dispatch/delivery/orders", {"json": {}}),
            ("patch", "/api/manual-dispatch/delivery/orders/ORDER-1", {"json": {}}),
            ("post", "/api/manual-dispatch/delivery/orders/ORDER-1/cancel", {}),
            ("post", "/api/manual-dispatch/delivery/orders/import-attache-pdf-commit", {"json": {"rows": []}}),
