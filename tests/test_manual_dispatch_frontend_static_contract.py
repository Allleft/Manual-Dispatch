...
class ManualDispatchFrontendStaticContractTest(unittest.TestCase):
    ...
    def test_countryside_opshop_pickup_frontend_contract(self):
        ...
        self.assertIn("Create Pickup Task", modal_renderer)
        ...
        self.assertIn("No actual Countryside pickup tasks have been created for this route group yet.", modal_renderer)
