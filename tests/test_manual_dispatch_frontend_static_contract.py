...
class ManualDispatchFrontendStaticContractTest(unittest.TestCase):
    ...
    def test_oncall_opshop_pickup_frontend_contract(self):
        ...
        self.assertIn("!candidateMatchesTemplateFilter(selectedCandidate, nextFilter)", actions)
        self.assertIn('schedule_id: ""', actions)
        self.assertGreaterEqual(actions.count('state.oncallOpShopPickupTemplateFilter = "";'), 4)
        ...
        self.assertIn("Search templates", modal_renderer)
        self.assertIn("Search by OP SHOP name, suburb, or address", modal_renderer)
